...
public class FastHandScorer : IHandScorer
{
    ...
    public static readonly int CLUB_OFFSET = 0;//13 * Clubs;
    public static readonly int DIAMOND_OFFSET = 13;//13 * Diamonds;
    public static readonly int HEART_OFFSET = 26;//13 * Hearts;
    public static readonly int SPADE_OFFSET = 39;//13 * Spades;
    ...
    {
        (Rank, Suit)[] fullHand = [.. handCards, .. communityCards];

        ulong cards = ParseHand(fullHand);
        return Evaluate(cards, fullHand.Length);
    }

    private static ulong ParseHand((Rank, Suit)[] hand)
    {
        ulong handmask = 0UL;
        int cards = hand.Length;
        ...
        {
            handmask |= 1UL << NextCard(card);
        }
        
        return handmask;
    }

    private static int NextCard((Rank rank, Suit suit) card)
    {
        int rank;
        int suit;
    ...
    private static uint Evaluate(ulong cards, int numberOfCards)
    {
