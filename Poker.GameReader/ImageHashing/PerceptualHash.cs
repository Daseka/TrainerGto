...
/// Perceptual hash; Calculate a hash of an image by first transforming the image to an 64x64 grayscale 
/// bitmap and then using the Discrete cosine transform to remove the high frequencies.
/// </summary>
internal class PerceptualHash
{
    ...
    public ulong Hash(Bitmap bitmap)
    {
